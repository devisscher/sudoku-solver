...
describe("SudokuComponent", () => {
  ...
  it(
    "should create the sudoku component",
    async(() => {
  ...
  it(
    `should have as title 'Sudoku Solver'`,
    async(() => {
      const fixture = TestBed.createComponent(SudokuComponent);
      const sudoku = fixture.debugElement.componentInstance;
  ...
  it(
    "should render title in a h2 tag",
    async(() => {
      const fixture = TestBed.createComponent(SudokuComponent);
  ...
  //   async(() => {
  //     const mockSudokuService: ISudokuService = {
  //       solvePuzzle: (sudoku: any): void => {},
  //     };
  //     const sudoku = new SudokuComponent(mockSudokuService);
  //   })
  // );
});
